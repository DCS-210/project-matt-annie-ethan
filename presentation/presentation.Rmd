...
### General research question: What are the main driving factors in exoplanet discovery, and how can these factors influence the future of exoplanet exploration?
...
-**Parsec**: A unit of distance used in astronomy equal to 3.26 light years (3.086 × 1013 kilometers). In other words, very far!



---
### Plotting Facilities and Discoveries Discover Count
...
### Linear Regression of Year on Distance 
...
### Linear Regression of Count on Discovery Year
``` {r count-on-time-reg}
time_reg <- linear_reg() %>%
  set_engine("lm") %>%
...
### Linear Regression of Count on Distance and Year
...
### Linear Regression of Count on Mean Distance 
...
### Popularity of discovery methods over time
...
- At the beginning of the project we sought out to predict the number of exoplanet discoveries in the next 5-20 years. We ultimately determined that innovations in discovery technology are the largest driver in new exoplanet discovery, so in order to predict the future we should research what steps are currently being made in the space industry to develop new technology.

- We feel that our data is very reliable in the sense that the information reported by NASA is accurate and correct. The data did have a lot of missing values, but they pertained to variables that we did not feel were relevant to our analysis.   

- The regression based analyses that we conducted did not have very high r-squared values and therefore it is likely that they were either too simple or did not show a significant correlation. That said, our visual-based analyses appeared to be statistically accurate and representaive of other similar literature/publications. 
