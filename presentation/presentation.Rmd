...
```{r discovery-facility-leaflet-labels, echo = FALSE}
...
### Linear regression of count vs mean distance and count vs discovery year
...
### Influence of country's GDP on the number of exoplanets discovered
