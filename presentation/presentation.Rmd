...
cleanup <- 
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
        panel.background = element_rect(fill = 'dodgerblue1', colour = 'white'), 
...
map_data <- 
  ...
  geom_point(data=facility_df, 
             aes(x=facility_longitude, y=facility_latitude,size = count,fill=facility_type,colour=facility_type), 
             pch=21, alpha=I(0.7))
map_data
```
