...
```{r animation, echo = FALSE, out.width = "1000%", fig.align = "center", fig.cap = "Image credit: Photo by Jörg Angeli on Unsplash."}
include_graphics("/cloud/project/Ethan.gif")
```
...
```{r animate-scatter, echo = FALSE, fig.show="hold", out.width="200%"}
